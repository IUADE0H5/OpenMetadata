...
import static org.openmetadata.service.migration.utils.v201.SearchNameKeywordRepair.repairNameKeywordSearchFields;
...
public class Migration extends MigrationProcessImpl {
  ...
  public void runDataMigration() {
    ...
    // Backfill the name.keyword search field on existing installs; the seed default alone
    // never reaches already-migrated clusters. Idempotent.
